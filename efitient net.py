...
model_top_path = "saved_model/efnet"
# Data preprocessing
...
if os.path.exists(model_top_path):
    ...
    tuner = RandomSearch(
        ...
        project_name='EfNet'  # Name of the tuning project
    )
    ...
    plot_model(model, to_file='model_plotef.png', show_shapes=True, show_layer_names=True)
    ...
    plt.legend()
    plt.savefig("saved_model/efnet/accuracy.png")
    plt.show()


# Function to predict and display images
def predict_image(filename):
    img = keras.preprocessing.image.load_img(filename, target_size=(250, 250))  # Updated target size
    plt.imshow(img)
